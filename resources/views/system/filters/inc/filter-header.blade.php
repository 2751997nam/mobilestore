    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="product-header" style="padding: 4px 0;">
                <p class="pull-left" style="margin-top: 4px;font-size: 1.6rem;color: #637381;display: none;">Unsaved changes</p>
                ...
                <button type="button" name="button" class="btn btn-flat pull-right btn-primary mr-3" id="btn-save-2" ng-click="save('save');">Lưu</button>
                <a href="/admin/filters" class="btn btn-flat btn-default pull-right" id="btn-cancel" style="margin: 0 10px;">Hủy</a>
            </div>
        </div>
    </nav>
</header>
