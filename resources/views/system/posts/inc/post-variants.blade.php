...
<div class="box no-border sb-variants" ng-class="{'collapsed-box': postVariants.length == 0}" ng-mouseover="initVariant();">
    <div class="box-header with-border">
        <h3 class="box-title">Biến thể bài viết</h3>
        <br>
        <h5>Thêm biến thể nếu bài viết của bạn có nhiều phiên bản khác nhau như màu sắc hoặc kích cỡ</h5>
        <div class="box-tools pull-right">
            <a href="javascript:;"
               ...
               data-toggle="tooltip"
            >
                <span ng-show="postVariants.length == 0">Thêm biến thể</span>
                <span ng-show="postVariants.length > 0 && !isOpen" ng-click="isOpen = true">Đóng</span>
                <span ng-show="postVariants.length > 0 && isOpen" ng-click="isOpen = false">Mở</span>
            </a>
        </div>
    </div>
    <div class="box-body" ng-style="{ 'display' : (postVariants.length == 0) ? 'none' : 'block' }" ng-mouseover="initLfm();">
        <div class="box-body table-responsive no-padding">
            <table class="table table-bordered">
                ...
                <tr ng-repeat="variant in variants">
                    ...
                    <td>
                        <button type="button" class="btn btn-default" ng-click="removeVariant($index)"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
                <tr>
                    <td>
                        <button type="button"
                                ...
                                ng-click="addVariant()"
                                class="btn btn-block btn-default btn-sm">Thêm biến thể</button>
                    </td>
                    <td colspan="2"></td>
                </tr>
            </table>
            <div class="sb-bulk-select" ng-show="postVariants.length > 0">
                Danh sách bài viết biến thể
            </div>
            <br>
            <table class="table table-hover" ng-show="postVariants.length > 0" style="font-size: 13px;">
                <tr>
                    <th> #</th>
                    <th>Biến thể</th>
                    <th>Ảnh</th>
                ...
                <tr ng-repeat="item in postVariants">
                    <td>@{{ $index + 1 }}</td>
                    <td>
                    ...
                    <td>
                        <div class="btn-group">
                            <a data-input="thumbnail-@{{$index}}" ng-if="!item.image_url" class="btn btn-sm btn-primary lfm">
                    ...
                    <td>
                        <button type="button" class="btn btn-default btn-sm" ng-click="removePostSku($index)"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
            </table>
        </div>
