                        ...
                        <div class="cart">
                            <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                ...
                                <div class="cart_content">
                                    <div class="cart_text"><a href="javascript:void(0)">Giỏ hàng</a></div>
                                </div>
                            </div>
                        </div>
                        <div id="cart-preview" class="d-none"></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="cat_menu_container">
                            ...
                            <ul class="cat_menu">
                                @foreach($categories as $category)
                                    <li><a href="{{ $category->url }}">{{ $category->name }}<i class="fas fa-chevron-right ml-auto"></i></a></li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="page_menu_content">
                        ...
                        <div class="page_menu_search">
                            <form action="{{ route('product.search') }}">
                                <input type="search" name="q" class="page_menu_search_input" placeholder="Tìm kiếm sản phẩm...">
                            </form>
                        </div>
